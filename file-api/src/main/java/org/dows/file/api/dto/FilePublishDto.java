...
/**
 * @description: 文件发布(FilePublish)DTO类
 * @author: VX:PN15855012581
 * @create: 2022-06-03 12:09:22
 */
@Data
@ToString
@Builder
...
public class FilePublishDto implements Serializable {
    private static final long serialVersionUID = 422317823212566757L;
